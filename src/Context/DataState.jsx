...
const DataState = (props) => {
    ...
    const [products, setProducts] = useState(
        [{ 'id': 1, 'number': 15, 'name': 'baby oil', 'hsn': 1504, 'rate':5, 'description': '50 ml bottle', 'sold': '5' },
        { 'id': 2, 'number': 18, 'name': 'biscuits', 'hsn': 19059040,'rate': 18,'description': '20 gm pkt', 'sold': '10' },
        { 'id': 3, 'number': 20, 'name': 'rice', 'hsn': 1006,'rate': 5, 'description': '25 kg bag', 'sold': '5' }])
